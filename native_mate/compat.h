...
#define MATE_METHOD_ARGS_TYPE   const v8::FunctionCallbackInfo<v8::Value>&
#define MATE_METHOD_RETURN_TYPE void

#define MATE_METHOD_SCOPE(isolate)     // nop
#define MATE_METHOD_RETURN(value)      return args.GetReturnValue().Set(value)
...
#define MATE_METHOD_ARGS_TYPE   const v8::Arguments&
#define MATE_METHOD_RETURN_TYPE v8::Handle<v8::Value>

#define MATE_METHOD_SCOPE(isolate)     v8::HandleScope scope
#define MATE_METHOD_RETURN(value)      return scope.Close(value)
...
#define MATE_METHOD(name) \
    MATE_METHOD_RETURN_TYPE name(MATE_METHOD_ARGS_TYPE args)
    v8::Local<type>::New(isolate, handle)
